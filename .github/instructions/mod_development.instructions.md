...
- **`Contents/mods/QuickForageIconDiscard/`** - Our main code folder where all development work happens
...
When developing features, always work in the `Contents/mods/QuickForageIconDiscard/` directory and reference any original mod code from `Contents_original_mod/` as needed (if applicable).
