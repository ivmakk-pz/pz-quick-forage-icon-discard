...
**Checkbox Format:**
Use GitHub-style checkboxes (`- [ ]` / `- [x]`) instead of emoji symbols (✅/❌) for task tracking and checklists. This provides better compatibility with GitHub markdown rendering and cleaner visual formatting.
